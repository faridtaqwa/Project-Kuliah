...
<html>
  ...
  <body>
    {{-- kop surat --}}
         ...
         {{-- namasurat --}}
        <table align="center">
            <tr><td> <b><u>SURAT KEHILANGAN KEMATIAN</u></b> </td>
            </tr>    
        </table>
        <table align="center">
            <tr><td>NO:472.12/220/p/x/200</td>
            </tr>    
        </table>
        ...
        <table class="table table-bordered" style="font-size: 11px; margin-bottom:0px;padding-bottom:0px;">
        
            <tbody class="tabel" style="padding-top: 0px;padding-bottom: 0px; width:30%;height:auto">
                <tr style="padding-top: 0px;padding-bottom: 0px; width:30%">
                    <td  style="padding-top: 0px;padding-bottom: 0px; width:30%">
                        <p style="margin-bottom: 0px"><b>Jenazah</b></p>
        ...
        <tbody class="tabel " >
            ...
            <tr class="tabe " >
                <td  style="padding-top: 0px;padding-bottom: 0px">
                    <p style="margin-bottom: 0px"><b>IBU</b></p>
        ...
        <tbody class="tabel " >
            <tr class="tabe " >
                <td  style="padding-top: 0px;padding-bottom: 0px">
                     <p style="margin-bottom: 0px"><b>AYAH</b></p>
                    <ol>
                        <li>NIK</li>
                        <li>Nama Lengkap</li>
                        <li>Tempat, Tanggal lahir</li>
        ...
        <tbody class="tabel " >
            <tr class=" " >
                <td  style="padding-top: 0px;padding-bottom: 0px">
                     ...
                     <p style="margin-bottom: 0px"><b>PELAPOR</b></p>
                    <ol>
                        <li>NIK</li>
                        <li>Nama Lengkap</li>
                        <li>Tempat, Tanggal lahir</li>
        ...
        <tbody class="tabel  " style="padding-bottom:0px " >
            <tr class="tabe " >
                <td class="saksi"  style="padding-top: 0px;padding-bottom: 0px">
                     <p style="margin-bottom: 0px"><b>Saksi1</b></p>
                    <ol>
                        <li>NIK</li>
                        <li>Pekerjaan</li>
                        <li>Umur</li>
