...
@section('content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-1">
        <h1 class="h3 mb-0 text-gray-800">Surat keterangan pindah Datang wni</h1>
    </div>
        ...
        <div class="col-md-12 card shadow mb-4">
            <form class="mt-3 mb-2" action="{{ route('pengajuan.store') }}" method="POST" enctype="multipart/form-data">
                @csrf                    
                    ...
                    <div class="form-group col-md-6">
                        <label for="inputState">Nomor Kartu Keluarga Pemohon</label>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input class="form-control" type="date" name="tgl_datang" >
                    </div>
