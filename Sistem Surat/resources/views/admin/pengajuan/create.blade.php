...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12 card shadow mb-4">
            <form class="mt-3 mb-2" action="{{ route('form-surat-admin') }}" method="POST" enctype="multipart/form-data">
                @csrf
                    <div class="form-group col-md-8">
                        ...
                        <select name="id_kategori" id="inputKategori" class="form-control">
                            ...
                            <option value="5">Formulir Permohonan Pindah WNI</option>
                            <option value="6">Surat Keterangan Pindah Datang</option>
                            <option value="7">Formulir Permohonan Pindah Datang WNI</option>
                        </select>
                    </div>
