            ...
            <form class="mt-3 mb-2" action="{{ route('warga.pengajuan.store') }}" method="POST" enctype="multipart/form-data">
                @csrf                    
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                        <label for="inputState">Jam meninggal</label>
                        <input class="form-control" type="text" name="jam_meninggal" >
                        </div>       
                        <div class="form-group col-md-6">
                    ...
                    <hr/>
                    <div class="row card card-group p-1 pt-4 m-1">
                        <div class="col-md-6">
                            <h3 class="h3 mx-2  text-gray-800">Saksi I </h3>
                        ...
                        <div class="col-md-6">
                            <h3 class="h3 mx-2 text-gray-800">Saksi II</h3>
                            <div class="form-group col-md-12">
                                <label for="inputState">NIK</label>
